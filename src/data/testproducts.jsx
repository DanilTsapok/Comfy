...
export const ProductContextTest = createContext();
...
export default function ProductProviderTest({ children }) {
  const [products, setProducts] = useState(ProductState);

  return (
    <ProductContextTest.Provider value={{ products, setProducts }}>
      {children}
    </ProductContextTest.Provider>
  );
}
